...
export const AROUND_ME_ITEMS = [
  ...
  { title: "내 주변 병원", href: "/map?category=hospitals", description: "현재 위치 기준 동물병원 탐색" },
  { title: "내 주변 미용", href: "/map?category=grooming", description: "반려동물 미용업소 위치 확인" },
  { title: "내 주변 유치원", href: "/map?category=daycare", description: "유치원·호텔·위탁관리 위치 확인" },
];
